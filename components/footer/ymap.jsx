...
const Ymap = ({ objRef, fs = false, lays = false, medcenters }) => {
  const mapData = {
    center: medcenters[0].coordinate.split(',').map((elem) => Number(elem)),
    zoom: 17,
    control: {
      ZoomControl: {
        visible: false,
          ...
          `
                  <div class="baloon">
                      ...
                      <div class="baloon__top-container">
                        ...
                        <p class="baloon__top-text">г. Пермь, ${data.address}
...
export default connect(mapStateToProps, null)(Ymap);
